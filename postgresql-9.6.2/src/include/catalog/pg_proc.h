...
//rcao add begin
DATA(insert OID =  442 (  yearin                    PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 21 "2275" _null_ _null_ _null_ _null_ _null_ yearin _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID =  443 (  yearout                   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 2275 "21" _null_ _null_ _null_ _null_ _null_ yearout _null_ _null_ _null_ ));
DESCR("I/O");

DATA(insert OID = 444 (  yearrecv                         PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 21 "2281" _null_ _null_ _null_ _null_ _null_      yearrecv _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 445 (  yearsend                         PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 17 "21" _null_ _null_ _null_ _null_ _null_ yearsend _null_ _null_ _null_ ));
DESCR("I/O");
//rcao add end
